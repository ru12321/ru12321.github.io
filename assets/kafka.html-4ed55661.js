import{_ as i,W as t,X as r,Y as s,Z as a,$ as l,a0 as n,C as p}from"./framework-715d567f.js";const o={},c=n(`<p>Ctrl + L 清屏</p><h2 id="linux知识" tabindex="-1"><a class="header-anchor" href="#linux知识" aria-hidden="true">#</a> Linux知识</h2><h3 id="集群配置" tabindex="-1"><a class="header-anchor" href="#集群配置" aria-hidden="true">#</a> 集群配置</h3><p><strong>做完步骤1、2、3、4后，就可以克隆虚拟机102，103，在102,103上面修改1、2的ip和hostname即可</strong></p><h4 id="_1-配置ip和网卡" tabindex="-1"><a class="header-anchor" href="#_1-配置ip和网卡" aria-hidden="true">#</a> 1.配置ip和网卡</h4><p>vim /etc/sysconfig/network-scripts/ifcfg-ens33</p><div class="language-txt line-numbers-mode" data-ext="txt"><pre class="language-txt"><code>TYPE=Ethernet                                                                                                       
PROXY_METHOD=none
BROWSER_ONLY=no
BOOTPROTO=static
DEFROUTE=yes
...
DNS1=8.8.8.8
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-配置主机名称" tabindex="-1"><a class="header-anchor" href="#_2-配置主机名称" aria-hidden="true">#</a> 2.配置主机名称</h4><p>vim /etc/hostname</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>tuyb101
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-配置ip和host映射" tabindex="-1"><a class="header-anchor" href="#_3-配置ip和host映射" aria-hidden="true">#</a> 3.配置ip和host映射</h4><p>vim /etc/hosts</p><div class="language-ssh line-numbers-mode" data-ext="ssh"><pre class="language-ssh"><code>192.168.10.101 tuyb101
...
<span class="token function">scp</span> <span class="token parameter variable">-r</span> /usr/local/jdk1.8.0_271/ root@tuyb102:/usr/local

<span class="token comment">#103上操作，从101拷贝文件：</span>
 <span class="token function">scp</span> <span class="token parameter variable">-r</span> root@tuyb101:/usr/local/jdk1.8.0_271/ ./
 
<span class="token comment">#102操作，从101拷贝文件到103</span>
<span class="token function">scp</span> <span class="token parameter variable">-r</span> root@tuyb101:/usr/local/jdk1.8.0_271/ root@tuyb103:/usr/local/jdktmp
...
<span class="token keyword">for</span> <span class="token for-or-select variable">host</span> <span class="token keyword">in</span> tuyb102 tuyb103
...
<span class="token assign-left variable">zookeeper.connect</span><span class="token operator">=</span>tuyb101:2181,tuyb102:2181,tuyb103:2181/kafka 
...
<span class="token string">&quot;start&quot;</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token keyword">for</span> <span class="token for-or-select variable">i</span> <span class="token keyword">in</span> tuyb101 tuyb102 tuyb103
        <span class="token keyword">do</span>
...
<span class="token keyword">for</span> <span class="token for-or-select variable">host</span> <span class="token keyword">in</span> tuyb101 tuyb102 tuyb103
<span class="token keyword">do</span>
        <span class="token builtin class-name">echo</span> <span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">=</span> <span class="token variable">$host</span> <span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">==</span><span class="token operator">=</span>
  ...
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">stream</span><span class="token punctuation">:</span>
      <span class="token key atrule">bindings</span><span class="token punctuation">:</span>
        <span class="token key atrule">ABCXXX_flow_input</span><span class="token punctuation">:</span> <span class="token comment">#spring stream的信道名称</span>
