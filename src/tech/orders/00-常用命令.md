---
jdicon: iconfont icon-ruyb-command
title: 常用命令
date: 2025-07-09
category: 命令
index: true
...
![image-20250606141616751](https://typora-imgbed-mrru.oss-cn-chengdu.aliyuncs.com/ruyb202507121059740.png)
...
![image-20250704133855370](https://typora-imgbed-mrru.oss-cn-chengdu.aliyuncs.com/ruyb202507121059958.png)
...
![null](https://typora-imgbed-mrru.oss-cn-chengdu.aliyuncs.com/ruyb202507121059453.png)
...
grep -B 50 -A 50 "2025-12-18 11:16:04.732" spring.log.2024-11-29.0
...
#创建一个50MB的文件
dd if=/dev/zero of=a.log bs=1M count=50

#定时任务
crontab -e

#定时任务：清空目录/data/logs中，以.log结尾的大于700M的文件
0 4 * * * /usr/bin/find /data/logs -name "*.log" -type f -size +700M -exec /usr/bin/truncate -s 0 {} \;
...
![image-20250622180615022](https://typora-imgbed-mrru.oss-cn-chengdu.aliyuncs.com/ruyb202507121100139.png)
