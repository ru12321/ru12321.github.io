...
![image-20230311133146598](./about_blog/image-20230311133146598.png)
...
* github新建仓库，命名要为`用户名.github.io`，如我的github用户名为ru12321，那么此次新仓库命名为`ru12321.github.io`，仓库地址如图获取
  ...
  ![image-20230311135650669](./about_blog/image-20230311135650669.png)
...
* 执行deploy.sh脚本，进入到脚本位置，右键使用git打开
  ...
  ![image-20230311135217147](./about_blog/image-20230311135217147.png)

* 执行脚本`sh deploy.sh`，上传项目打包文件到远端github.io仓库

![image-20230311135303902](./about_blog/image-20230311135303902.png)
...
![image-20230311135904991](./about_blog/image-20230311135904991.png)
...
![image-20230311141326887](./about_blog/image-20230311141326887.png)

至此，远端仓库有了两个分支

![image-20230311141617167](./about_blog/image-20230311141617167.png)
...
![image-20230311142430423](./about_blog/image-20230311142430423.png)
...
![image-20230311142714721](./about_blog/image-20230311142714721.png)
...
![image-20230311143235520](./about_blog/image-20230311143235520.png)



* 操作完后就会生成一个secret

  ![image-20230311143502963](./about_blog/image-20230311143502963.png)
...
![image-20230311143938914](./about_blog/image-20230311143938914.png)
...
![image-20230311144241070](./about_blog/image-20230311144241070.png)

## 写在最后

初次尝试搭建博客，过程中有其它问题也欢迎交流，可以通过github提出issue~
